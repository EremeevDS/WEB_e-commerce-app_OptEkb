...
class ProfileView(CartMixin, TemplateView):
...
class DeliveryView(CartMixin, TemplateView):
...
class ContactsView(CartMixin, TemplateView):
...
class FeedbackView(CartMixin, TemplateView):
...
class GuaranteeView(CartMixin, TemplateView):
...
class HowtobuyView(CartMixin, TemplateView):
...
class SearchView(ListView, CartMixin):
    model = Product
